package slode.elsloude.guessstar;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void getContent() {
        DownloadContantTask task = new DownloadContantTask();
        try {
    ...
    public void onClickAnswer(View view) {
        ...
        if (Integer.parseInt(tag) == numberOfRightAnswer) {
            ...
            Toast.makeText(this, "Не верно! Правильно - это ответ: " + names.get(numberOfQuestion), Toast.LENGTH_LONG).show();
        }
        playGame();
    }

    private static class DownloadContantTask extends AsyncTask<String, Void, String> {
        @Override
